...
class TabDtbhViewController: UIViewController , UITabBarDelegate,UITableViewDataSource, CalendarPopUpDelegate, Protocol{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        var myobj = Utils.getbyloai_dtbh(items: bcth, loai: chon)
    ...
    func getdata ()
    {
        ...
        let url_vlr = "http://www.simmobi.vn:8090/QLCVMobiWebService/wsqlcv?cmd=110&userid=7592&ms_phongban=620&mucquyen=4&istrungtam=1&thang="+myFilter.thang+"&nam="+myFilter.nam+"&idtinh="+myFilter.tinh+"&loai=" + myFilter.loai
        ...
        let task = URLSession.shared.dataTask(with: urllink) { (data, _, _) in
            ...
            print(data)
            do {
                    let vlr = try JSONDecoder().decode(BcbhObj.self, from: data)
