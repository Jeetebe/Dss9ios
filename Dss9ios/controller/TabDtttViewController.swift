...
class TabDtttViewController: UIViewController , UITabBarDelegate,UITableViewDataSource, CalendarPopUpDelegate, Protocol{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        var myobj = Utils.getbyloai_dttt(items: bcth, loai: chon)
...
//                {}
    ...
    func getdata ()
    {
        ...
        guard  let url = URL(string: url_dttt)
        ...
        let task = URLSession.shared.dataTask(with: url) { (data, _, _) in
            ...
            print(data)
            do {
                let bcth: DtttObj = try JSONDecoder().decode(DtttObj.self, from: data)
                //et user = User(data)
